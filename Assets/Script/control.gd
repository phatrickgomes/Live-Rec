...
var jamv_truck = preload("res://Assets/Scenes/jamv_truck.tscn")
var jamv_chupetao = preload("res://Assets/Scenes/jamv_chupetao.tscn")
var fight_music = preload("res://Assets/Scenes/fight_music.tscn")
